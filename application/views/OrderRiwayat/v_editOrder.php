		...
		<div class="col-sm-12">
			<div class="card">
				<div class="card-header">
					...
					<h4 class="card-title text-warning"><b>#<?= $data['t_order_kode']; ?></b></h4>
					<input type="hidden" class="form-control" id="t_order_kode" name="t_order_kode" value="<?= $data['t_order_kode']; ?>" />
				</div>
				<div class="card-body">
					<div class="row">
						<div class="col-sm-8">
							...
							<div class="row mt-1">
								<div class="col-xl-4 col-md-6 col-12">
									<div class="mb-1">
										...
										<input type="text" class="form-control" id="t_order_paket_id" name="t_order_paket_id" value="<?= $data['t_order_paket_id']; ?>" />
									</div>
								</div>
								<div class="col-xl-4 col-md-6 col-12">
									<div class="mb-1">
										<label class="form-label" for="t_order_tgl_order">Tanggal Order</label>
										<input type="date" class="form-control" id="t_order_tgl_order" name="t_order_tgl_order" value="<?= $data['t_order_tgl_order']; ?>" />
									</div>
								</div>
								<div class="col-xl-4 col-md-6 col-12">
									<div class="mb-1">
										<label class="form-label" for="t_order_tgl_kirim">Tanggal Kirim <small class="text-muted">(Estimasi)</small></label>
										<input type="date" class="form-control" id="t_order_tgl_kirim" name="t_order_tgl_kirim" value="<?= $data['t_order_tgl_kirim']; ?>" />
									</div>
								</div>
							</div>
...
<script>
	$(document).ready(function() {
		$("#show_tableProduk").load("<?= base_url('OrderRiwayat/ShowTableEditProduk/' . $data['t_order_kode'] . ''); ?>");
	});
</script>