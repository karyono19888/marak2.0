						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<span
										class="badge rounded-pill badge-light-danger me-1"><?= $key['m_visit_status']; ?></span>
									<?php elseif ($key['m_visit_status'] == "Prognosa") : ?>
									<span
										class="badge rounded-pill badge-light-warning me-1"><?= $key['m_visit_status']; ?></span>
									<?php else : ?>
									<span
										class="badge rounded-pill badge-light-primary me-1"><?= $key['m_visit_status']; ?></span>
									<?php endif; ?>
								</td>
								<td class="text-center" width="20%">
									<a href="#" type="button" data-id="<?= $key['m_visit_history_id']; ?>"
										class="btn btn-flat-primary btn-sm Pilih">Pilih</a>
								</td>
							</tr>
							<?php endforeach; ?>
						</tbody>
