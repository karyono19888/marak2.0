<div class="card">
	<div class="card-header">
		...
		<div class="button">
			<a href="#" class="btn btn-success E-commers" type="button">
				<span><i data-feather='plus'></i> Add New E-commers</span>
			</a>
			<a href="#" class="btn btn-primary Tambah" type="button">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center" width="15%">
							...
							<?php else : ?>
							<a href="#" type="button" class="btn btn-gradient-warning btn-sm EditRequest my-1"
								data-id="<?= $a['t_req_id']; ?>">Edit</a>
							<a href="#" type="button" class="btn btn-gradient-danger btn-sm Delete"
								data-id="<?= $a['t_req_id']; ?>">Delete</a>
							<?php endif; ?>
						</td>
					</tr>
					<?php endforeach; ?>
