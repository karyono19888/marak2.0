		...
		<div class="content-header row">
			<div class="content-header-left col-md-9 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h2 class="content-header-title float-start mb-0">Laporan Summary</h2>
						<div class="breadcrumb-wrapper">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#">HRD</a>
								</li>
		...
		<div class="content-body">
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="card">
						<div class="card-header">
							<div class="card-title">Laporan Aktivitas Marketing</div>
						</div>
						<div class="card-body">
								...
								<div class="row">
									<div class="col-sm-6 position-relative">
										<div class="mb-1">
											...
											<input type="date" class="form-control pickadate" id="date_start_laporan"
												name="date_start_laporan" placeholder="YYYY:MM:DD" />
										</div>
									</div>
									<div class="col-sm-6 position-relative">
										<div class="mb-1">
											<label class="form-label" for="date_end_laporan">Tanggal Selesai</label>
											<input type="date" class="form-control pickadate" id="date_end_laporan"
												name="date_end_laporan" placeholder="YYYY:MM:DD" />
										</div>
									</div>
								</div>
							</form>
				...
				<div class="col-sm-6">
					<div class="card">
						<div class="card-header">
							<div class="card-title">Laporan Aktivitas Project</div>
						</div>
						<div class="card-body">
							<form id="formSumamry">
								<div class="row">
...
$(document).on("click", "#tombol_laporan", function() {
	if (validasi()) {
		...
		$.ajax({
			type: 'POST',
			url: '<?= base_url('HrdLaporan/ShowDataLaporanKunjungan'); ?>',
			data: data,
