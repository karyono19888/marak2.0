					...
					?>
						<tr>
							...
							<td class="text-center" width="20%">
								<a href="#" type="button" class="btn btn-gradient-warning btn-sm Edit" data-id="<?= $a['m_prod_id']; ?>">Edit</a>
								<a href="#" type="button" class="btn btn-gradient-danger btn-sm Delete" data-id="<?= $a['m_prod_id']; ?>">Delete</a>
							</td>
						</tr>
					<?php endforeach; ?>
				</tbody>
