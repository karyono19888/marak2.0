					...
					<div class="row">
						<div class="col-sm-4">
							<div class="mb-1">
								...
								<input type="text" id="m_uom_kode" class="form-control" placeholder="Kode Produk" name="m_uom_kode" />
							</div>
						</div>
						<div class="col-sm-4">
							<div class="mb-1">
								<label class="form-label" for="m_uom_symbol">Symbol</label>
								<input type="text" id="m_uom_symbol" class="form-control" placeholder="Kode Produk" name="m_uom_symbol" />
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-4">
							<div class="mb-1">
								...
								<input type="text" id="m_uom_nama" class="form-control" placeholder="Nama Produk" name="m_uom_nama" />
							</div>
						</div>
						<div class="col-sm-4">
