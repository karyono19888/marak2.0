					...
					<div class="row">
						<div class="col-sm-8">
								...
								<tbody>
									...
									<tr>
										...
										<input type="hidden" class="form-control" id="t_order_perusahaan"
											name="t_order_perusahaan" value="<?= $data['org_id']; ?>" />
									</tr>
								</tbody>
							</table>

							<div id="showEcommerce"
								<?= $data['t_req_kategori'] == "E-Commerce" ? '' : 'style="display: none;"' ?>>
								<hr>
							...
							<input type="hidden" class="form-control" id="t_order_visit_history_id"
								name="t_order_visit_history_id" value="<?= $data['m_visit_history_id']; ?>" />
							<input type="hidden" class="form-control" id="t_order_visit_id" name="t_order_visit_id"
								value="<?= $data['m_visit_id']; ?>" />
						</div>
