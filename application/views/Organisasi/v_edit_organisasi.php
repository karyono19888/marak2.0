		...
		<div class="content-header row">
			<div class="content-header-left col-md-9 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h2 class="content-header-title float-start mb-0">Edit Organisasi</h2>
						<div class="breadcrumb-wrapper">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="<?= base_url('Organisasi'); ?>">Organisasi</a>
								</li>
								<li class="breadcrumb-item active">Edit Organisasi
								</li>
							</ol>
						</div>
					</div>
					...
					<div class="col-sm-8">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Edit Data - <span class="fw-bolder"><?= $edit['org_nama']; ?></span></h4>
							...
							<div class="card-body">
								<div class="row">
									...
									<form id="tambahOrganisasiForm" class="row gy-1" method="POST" action="">
										<input type="hidden" name="org_id" id="org_id" value="<?= $edit['org_id']; ?>">
										<div class="col-12">
											<label class="form-label" for="org_nama">Nama Organisasi<span class="text-danger">*</span></label>
											<div class="input-group input-group-merge">
												<span class="input-group-text"><i data-feather="user"></i></span>
												<input type="text" id="org_nama" class="form-control" name="org_nama" placeholder="Masukan Nama Organisasi" value="<?= $edit['org_nama']; ?>" style="text-transform:capitalize ;" />
											</div>
										</div>
										<div class="col-12 col-md-6">
											...
											<div class="input-group input-group-merge">
												...
												<input type="email" id="org_email" class="form-control" name="org_email" placeholder="contoh@email.com" value="<?= $edit['org_email']; ?>" />
											</div>
										</div>
										<div class="col-12 col-md-6">
											...
											<div class="input-group input-group-merge">
												...
												<input type="number" id="org_phone" class="form-control" name="org_phone" placeholder="021 123 456 78" value="<?= $edit['org_phone']; ?>" />
											</div>
										</div>
										<div class="col-12">
											<label class="form-label" for="org_alamat">Alamat Lengkap <span class="text-danger">*</span></label>
											<textarea name="org_alamat" id="org_alamat" cols="30" rows="4" class="form-control" placeholder="Masukan Alamat lengkap"><?= $edit['org_alamat']; ?></textarea>
										</div>
										<div class="col-12 col-md-6">
											...
											<select id="wilayah" name="wilayah" class="form-select" aria-label="Default select example">
												<option value="<?= $edit['wilayah_id']; ?>"><?= $edit['wilayah_nama']; ?></option>
											</select>
										</div>
										<div class="col-12 col-md-6">
											...
											<select id="provinsi" name="provinsi" class="form-select" aria-label="Default select example">
												<option value="<?= $edit['id_prov']; ?>"><?= $edit['prov_nama']; ?></option>
											</select>
										</div>
										<div class="col-12 col-md-6">
											...
											<select id="kabupaten" name="kabupaten" class="form-select" aria-label="Default select example">
												<option value="<?= $edit['id_kab']; ?>"><?= $edit['kab_nama']; ?></option>
											</select>
										</div>
										<div class="col-12 col-md-6">
											...
											<select id="kecamatan" name="kecamatan" class="form-select" aria-label="Default select example">
												<option value="<?= $edit['id_kec']; ?>"><?= $edit['nama']; ?></option>
											</select>
										</div>
...
<script>
	$(document).on("click", "#tombol_update", function() {
		if (validasi()) {
			...
			$.ajax({
				type: 'POST',
				url: '<?= base_url('Organisasi/UpdateOrganisasi'); ?>',
				data: data,
