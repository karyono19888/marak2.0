	...
	<div class="col-sm-9">
		<div class="card">
			<div class="card-header">
				<h4 class="card-title"><b>Edit Tipe Baru</b></h4>
			</div>
			<div class="card-body">
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="mb-1">
								...
								<input type="hidden" id="m_tipe_id" class="form-control" placeholder="Kode" name="m_tipe_id" value="<?= $data['m_tipe_id']; ?>" />
								<input type="text" id="m_tipe_kode" class="form-control" placeholder="Kode" name="m_tipe_kode" value="<?= $data['m_tipe_kode']; ?>" />
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-4">
							<div class="mb-1">
								...
								<input type="text" id="m_tipe_nama" class="form-control" placeholder="Nama" name="m_tipe_nama" value="<?= $data['m_tipe_nama']; ?>" />
							</div>
						</div>
						<div class="col-sm-4">
							...
							<select class="form-select select2" id="m_tipe_status" name="m_tipe_status">
								<?php if ($data['m_tipe_status'] == "Aktif") : ?>
									<option value="<?= $data['m_tipe_status']; ?>"><?= $data['m_tipe_status']; ?></option>
						...
						<div class="col-sm-4">
							<div class="mb-1">
								...
								<textarea name="m_tipe_deskripsi" id="m_tipe_deskripsi" cols="30" rows="3" class="form-control" placeholder="Deskripsi"><?= $data['m_tipe_deskripsi']; ?></textarea>
							</div>
						</div>
					</div>
				</form>
...
<script>
	$(document).on("click", "#tombol_simpan", function() {
		if (validasi()) {
			...
			$.ajax({
				type: 'POST',
				url: '<?= base_url('MasterTipe/EditTipe'); ?>',
				data: data,
