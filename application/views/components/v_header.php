...
<head>
	...
	<meta name="description"
		content="Marak Marketing aktivity, aplikasi aktivitas marketing &amp; modern responsive with unlimited possibilities.">
	<meta name="keywords"
		content="Marak, Marakapp, marak, marakapp, marketing fokus, fokus indo lighting, pt fokus indo lighting, PT Fokus Indo Lighting, PT FOKUS INDO LIGHTING">
	...
	<link rel="stylesheet" type="text/css"
		href="<?= base_url('assets'); ?>/css/plugins/extensions/ext-component-toastr.css">
	<!-- END: Page CSS-->
